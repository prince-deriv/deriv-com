/* eslint-disable  */
new_texts = [
    <Localize translate_text="Redirect noticessssssss" />,
    <Localize translate_text="You are being redirected to an external websitessssssss." />,
    <Localize translate_text="Cancelsssssss" />,
