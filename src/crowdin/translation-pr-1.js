...
new_texts = [
    ...
    <Localize translate_text="new-text:1" />,
    <Localize translate_text="new-text:2" />,
    <Localize translate_text="new-text:3" />,
    <Localize translate_text="new-text:yes" />,
    <Localize translate_text="new-text:no" />,
    <Localize translate_text="new-text:true" />,
    <Localize translate_text="new-text:false" />,
    <Localize translate_text="new-text:done" />,
